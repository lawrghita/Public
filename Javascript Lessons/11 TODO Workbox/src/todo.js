    ...
    .on("keypress", function (event) {
        ...
        if (event.key === "Enter" && todoText !== "") {
            ...
            if ($("li:first-of-type").length !== 0) {
                $("<li><span><img class=\"delete\" src=\"images/calendar-times-regular.svg\" alt=\"delete\"></span> " + todoText + "<img alt=\"check\" class=\"check\" src=\"images/calendar-check-regular.svg\"></li>").insertBefore(
                    "li:first-of-type"
                );
            } else {
                // all li deleted so insert an li into existed empty ul
                $("<li><span><img class=\"delete\" src=\"images/calendar-times-regular.svg\" alt=\"delete\"></span> " + todoText + "<img alt=\"check\" class=\"check\" src=\"images/calendar-check-regular.svg\"></li>").appendTo("ul"); // console.log($(this).val(), this.value, todoText, " ELSE LI first of type", $("li:first-of-type"));
            }
